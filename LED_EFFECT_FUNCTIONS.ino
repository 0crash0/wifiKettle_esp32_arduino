void ws2812_showMode(int ldMODE) {

  switch (ldMODE) {
    case 888: demo_modeA(); break;             // длинное демо
    case 889: demo_modeB(); break;             // короткое демо
    case 890:  Serial.println((String)o_CLR_R + (String) + " " + o_CLR_G + (String) + " " +  o_CLR_B); break;                                     ///////////////       one_color_all(o_CLR_R, o_CLR_G, o_CLR_B);   LEDS.show();
